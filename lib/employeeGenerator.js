const { generateCards, generateEngineer, generateIntern, generatePage, writeFile } = require('../src/template');
...
class employeeGenerator {
    ...
    getManagerInfo() {
        inquirer.prompt([
            ...
            this.employeeInfo.push(this.manager);
            // send to function to create html
            //generateManager(this.manager);
    ...
    getNewEmployeeInfo() {
        inquirer.prompt([
            ...
            if (newEmployee === 'Intern') {
                ...
                generatePage(this.employeeInfo);
            }
        });
    };
    ...
    getNewEngineer() {
        inquirer.prompt([
            ...
            this.employeeInfo.push(this.engineer);
    ...
    getNewIntern() {
        inquirer.prompt([
            ...
            this.employeeInfo.push(this.intern);
